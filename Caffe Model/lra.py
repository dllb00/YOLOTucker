...
proto_input = "/opt/caffe/examples/cifar10/cifar10_quick_train_test.prototxt" # Architecture of network (layer configuration) darknet: .cfg
weight_input = "/opt/caffe/examples/cifar10/cifar10_quick_iter_5000.caffemodel.h5" # darknet: .weights
